    ...
    <section id="complaint" className="py-20 md:py-32 px-4 bg-gradient-to-br from-primary via-primary-dark to-primary relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-cream/90 max-w-2xl mx-auto leading-relaxed">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-3 px-10 py-5 text-lg font-bold rounded-full bg-cream text-primary hover:bg-white transition-all shadow-2xl"
            >
