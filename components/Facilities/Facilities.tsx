...
export default function Facilities({ locale }: FacilitiesProps) {
  ...
  return (
    <section id="facilities" className="py-16 md:py-24 px-4 bg-cream-light">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {facilities.map((facility, index) => (
            <motion.div
              ...
              className="flex flex-col items-center text-center p-6 bg-cream rounded-2xl shadow-md hover:shadow-lg transition-shadow"
            >
